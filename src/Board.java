...
public class Board {
	/*
	 * index of the array represents the positions of the tiles on the board The
	 * contents of the array will be represented from numbers 1-9 and 0 for the
	 * blank position
	 */
	...
	/*
	 * Modified toString method for the BoardState (non-Javadoc)
	 * 
	...
	public Board move(int tileToBeMoved) {
		...
		for (int x = 0; x < SIZE; x++) {
			for (int y = 0; y < SIZE; y++) {
				if (childBoard[x][y].getValue() == tileToBeMoved
						&& childBoard[x][y].isMovable()) {
